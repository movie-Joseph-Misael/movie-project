...
function showMovies(movies) {
    ...
    `;
        ...
        //                     movieCard.querySelector(".movie-title").textContent = title.value;
        //                     movieCard.querySelector(".movie-vote").textContent = rating.value;
        //                     movieCard.querySelector(".movie-img").src = urlImage.value;
